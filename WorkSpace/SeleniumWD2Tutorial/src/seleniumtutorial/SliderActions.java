...
public class SliderActions {
	...
	public void testSliderActions() throws Exception {
		...
		WebElement element = driver.findElement(By.xpath("//div[@id='sl_temp_1']//div[@class='dhxsl_runner']"));
		Actions action = new Actions(driver);
		action.dragAndDropBy(element, 0, 100).build().perform();
/*
 * This website no longer have the demo text box available
 // section[@class='hero-form siteid-1 langid-1033'][position()=1]//a[text()='31']
		// Using the text box
		Thread.sleep(3000);
