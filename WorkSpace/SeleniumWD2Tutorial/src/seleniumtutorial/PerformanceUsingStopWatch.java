...
public class PerformanceUsingStopWatch {
	...
	public void beforeClass() throws Exception {
		...
		ExcelUtility1.setExcelFile(Constants.File_Path + Constants.File_Name, "Sheet1");
	}
	...
	public void searchFlight() throws Exception {
		...
		searchPage.setDepartureDate("10/28/2016");
		searchPage.setReturnDate("10/31/2016");
		double seconds = (double) watch.getTime() / 1000.0;
		watch.reset();
		log.info("**********************************************");
		log.info("Time taken to exeute this method was: " + seconds + " seconds");
//		ExcelUtility1.setCellData("Flight Page", 1, 0);
//		ExcelUtility1.setCellData(seconds, 1, 1);
	}
