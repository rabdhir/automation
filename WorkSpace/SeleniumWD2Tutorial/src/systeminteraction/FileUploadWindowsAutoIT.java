...
public class FileUploadWindowsAutoIT {
	...
	public void fileUpload() throws AWTException, InterruptedException, IOException {
		driver.findElement(By.id("Email")).sendKeys("rahmat.abdhir@gmail.com");
		driver.findElement(By.id("next")).click();
		driver.findElement(By.id("Passwd")).sendKeys("ArimandO@0929"); // Enter your password
		// EnterPassword.enterPassword(driver); // Comment this
		driver.findElement(By.id("signIn")).click();
		driver.findElement(By.xpath("//div[text()='COMPOSE']")).click();
		driver.findElement(By.xpath("//div[@class='wO nr l1']//textarea")).sendKeys("rahmat.abdhir@gmail.com");
		...
		Runtime.getRuntime().exec("C:\\automation\\WorkSpace\\SeleniumWD2Tutorial\\scripts\\fileupload.exe");
