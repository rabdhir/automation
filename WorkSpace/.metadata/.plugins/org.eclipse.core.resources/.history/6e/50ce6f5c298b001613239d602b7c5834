...
public class CalendarSelection {
	...
	public void test1() throws Exception {
		...
		WebElement dateToSelect = driver.findElement(
				By.xpath("//button[@class='datepicker-cal-date'][@data-month='9'][@data-day='27']"));
		// Click the date
		dateToSelect.click();
		//System.out.println("Departure date selected is: " + dateToSelect);
	...
	public void test2() throws Exception {
		...
		WebElement calMonth = driver.findElement(
				By.xpath("//button[@class='datepicker-cal-date'][@data-month='9']"));
